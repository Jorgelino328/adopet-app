  ...
  Future<void> _submit() async {
    ...
    final success = _isSignUp
        ? await _authService.signUp(
            ...
            existingPets: _existingPetsController.text,
          )
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) => value == null || value.length < 6 ? 'Use pelo menos 6 caracteres' : null,
                    ),
                    const SizedBox(height: 12),
                    if (_isSignUp)
                      TextFormField(
                        controller: _preferencesController,
                        decoration: const InputDecoration(labelText: 'Preferências (ex.: gatos, filhotes)'),
                        maxLines: 2,
                      ),
                    if (_isSignUp) const SizedBox(height: 12),
                    if (_isSignUp)
                      TextFormField(
                        ...
                        decoration: const InputDecoration(labelText: 'Pets que você já tem (opcional)'),
                        maxLines: 2,
                      ),
                    ...
                    TextButton(
                      ...
                      child: Text(_isSignUp ? 'Já tenho conta' : 'Criar uma conta'),
                    ),
                  ],
                ),
              ),
